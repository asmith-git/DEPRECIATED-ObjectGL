#ifndef OBJECT_GL_TESS_EVALUATION_SHADER_HPP
#define OBJECT_GL_TESS_EVALUATION_SHADER_HPP
...
/*!
	\file ShaderTessellationEvaluation.hpp
	\brief
	\author Adam Smith
...
namespace ObjectGL{
	...
	*/
	...
	public:
		TessellationEvaluationShader(Context& aContext, SourceFactory& aSource);
...
#include "ShaderTessellationEvaluation.inl"
