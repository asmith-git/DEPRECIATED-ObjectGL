#ifndef OBJECT_GL_FRAGMENT_SHADER_HPP
#define OBJECT_GL_FRAGMENT_SHADER_HPP
...
namespace ObjectGL{
	...
	*/
	...
	public:
		FragmentShader(Context& aContext, SourceFactory& aSource);
		~FragmentShader();
