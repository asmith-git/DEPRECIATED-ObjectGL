#ifndef OBJECT_GL_VERTEX_SHADER_HPP
#define OBJECT_GL_VERTEX_SHADER_HPP
...
namespace ObjectGL{
	...
	*/
	...
	public:
		VertexShader(Context& aContext, SourceFactory& aSource);
		~VertexShader();
