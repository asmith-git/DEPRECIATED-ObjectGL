#ifndef OBJECT_GL_TESS_CONTROL_SHADER_HPP
#define OBJECT_GL_TESS_CONTROL_SHADER_HPP
...
/*!
	\file ShaderTessellationControl.hpp
	\brief
	\author Adam Smith
...
namespace ObjectGL{
	...
	*/
	...
	public:
		TessellationControlShader(Context& aContext, SourceFactory& aSource);
...
#include "ShaderTessellationControl.inl"
