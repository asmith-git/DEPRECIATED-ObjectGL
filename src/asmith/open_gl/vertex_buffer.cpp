...
namespace asmith { namespace gl {
	...
	static uint8_t buffer_target_to_index(const GLenum aTarget) throw() {
		...
		case GL_DISPATCH_INDIRECT_BUFFER	: return 4;
		case GL_DRAW_INDIRECT_BUFFER		: return 5;
		case GL_ELEMENT_ARRAY_BUFFER		: return 6;
		case GL_PIXEL_PACK_BUFFER			: return 7;
		case GL_PIXEL_UNPACK_BUFFER			: return 8;
		case GL_QUERY_BUFFER				: return 9;
		case GL_SHADER_STORAGE_BUFFER		: return 10;
		case GL_TEXTURE_BUFFER				: return 11;
		case GL_TRANSFORM_FEEDBACK_BUFFER	: return 12;
		case GL_UNIFORM_BUFFER				: return 13;
	...
	static uint8_t index_to_buffer_targer(const GLenum aTarget) throw() {
		...
		case 1: return GL_ATOMIC_COUNTER_BUFFER;
		case 2: return GL_COPY_READ_BUFFER;
		case 3: return GL_COPY_WRITE_BUFFER;
		case 4: return GL_DISPATCH_INDIRECT_BUFFER;
		case 5: return GL_DRAW_INDIRECT_BUFFER;
		case 6: return GL_ELEMENT_ARRAY_BUFFER;
		case 7: return GL_PIXEL_PACK_BUFFER;
		case 8: return GL_PIXEL_UNPACK_BUFFER;
		case 9: return GL_QUERY_BUFFER;
		case 10: return GL_SHADER_STORAGE_BUFFER;
		case 11: return GL_TEXTURE_BUFFER;
		case 12: return GL_TRANSFORM_FEEDBACK_BUFFER;
		case 13: return GL_UNIFORM_BUFFER;
