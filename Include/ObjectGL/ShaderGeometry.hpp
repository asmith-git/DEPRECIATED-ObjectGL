#ifndef OBJECT_GL_TESS_GEOMETRY_HPP
#define OBJECT_GL_TESS_GEOMETRY_HPP
...
namespace ObjectGL{
	...
	*/
	...
	public:
		GeometryShader(Context& aContext, SourceFactory& aSource);
		~GeometryShader();
